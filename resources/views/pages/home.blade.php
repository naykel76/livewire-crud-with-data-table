<x-gotime-app-layout layout="{{ config('naykel.template') }}" class="flex markdown">
    ...
    <div class="container-xxl flex gap py">
        <div class="w-lg">
            <div class="bx pxy-1">
                ...
                <p>A form with validation using the Crudable trait and form object and Converts <code>PublishedStatus</code> enum to array of options for select input.</p>
            </div>
